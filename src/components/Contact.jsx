            ...
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href,icon},key) => (
                        <a key={key} href={href} target='_blank' className='w-12 h-12 grid place-items-center ring-inset ring-2  ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-sky-500 hover:text-zinc-950 active:bg-zinc-50/80 '  >
                            {icon}
                        </a>
                    ))}
                </div>
            ...
            <form action="https://getform.io/f/bxoojyka" method='POST' className='xl:pl-10 2xl:pl-20' >
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete='name' required placeholder='Enter your name' className='text-field' />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <input type="text" name="email" id="email" autoComplete='email' required placeholder='Enter your email' className='text-field' />
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea name="message" id="message" required placeholder='Type your message here...' className="text-field resize-y min-h-32 max-h-80 " >
